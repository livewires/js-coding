...
Let's add a simple `HTML` form to our page. Go into your `index.html` file and add the following lines in the `<body>` tag. It's really important that these go *before* the `<script src="script.js"></script>` line:
